    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="brand-container py-6 flex-1">
        ...
        <div className="max-w-3xl mt-8">
          <h1 className="font-marmelad font-bold text-[#392F3B] text-4xl md:text-5xl mb-6">Сотрудничество</h1>
          <div className="space-y-4 text-[#756977] font-snpro leading-relaxed">
            <p>
          ...
          <div className="mt-8 p-5 bg-[#f5f0f6] rounded-xl flex items-center gap-4">
            ...
            <div>
              <p className="font-snpro text-[#392F3B] font-medium">По вопросам сотрудничества:</p>
              <a href="mailto:KCC@bookscult.ru" className="font-marmelad font-bold text-[#E4610F] text-lg hover:underline">KCC@bookscult.ru</a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 mb-10">
          <h2 className="font-marmelad font-bold text-[#392F3B] text-2xl mb-6">Где купить офлайн</h2>
            ...
            {STORES.map((s) => (
              <div key={s.city} className="border border-[#e8e2ea] rounded-xl p-5">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-marmelad font-bold text-[#392F3B] text-lg">{s.city}</h3>
                </div>
                <ul className="space-y-1">
                  {s.shops.map((shop) => (
                    <li key={shop} className="flex items-center gap-2 text-[#756977] font-snpro text-sm">
          ...
          <blockquote className="mt-10 border-l-4 border-[#E4610F] pl-6 py-2">
            <p className="font-snpro text-[#756977] italic text-lg leading-relaxed">
              «Мы делаем книжки, которые и сами хотели бы читать. И хотим, чтобы их могли найти везде, где есть настоящие читатели.»
            </p>
            <cite className="font-marmelad text-[#392F3B] font-semibold text-sm mt-2 block not-italic">— Команда KRAS COMICS CULT</cite>
          </blockquote>
        </div>
      </div>
      <Footer />
