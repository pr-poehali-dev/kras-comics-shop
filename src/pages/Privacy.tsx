  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="brand-container py-6 flex-1">
        <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-[#756977] hover:text-[#E4610F] font-golos text-sm transition-colors mb-6">
          <Icon name="ArrowLeft" size={16} /> Вернуться
        </button>
        <div className="max-w-2xl mb-12">
          <h1 className="font-oswald font-bold text-[#392F3B] text-3xl md:text-4xl mb-6">Политика конфиденциальности</h1>
          <div className="prose font-golos text-[#756977] leading-relaxed space-y-4 text-sm">
            ...
            <h2 className="font-oswald text-[#392F3B] text-lg mt-6">Оператор персональных данных</h2>
            ...
            <h2 className="font-oswald text-[#392F3B] text-lg mt-6">Какие данные мы собираем</h2>
            ...
            <h2 className="font-oswald text-[#392F3B] text-lg mt-6">Цели обработки</h2>
            ...
            <h2 className="font-oswald text-[#392F3B] text-lg mt-6">Хранение и передача данных</h2>
            ...
            <h2 className="font-oswald text-[#392F3B] text-lg mt-6">Права субъекта данных</h2>
